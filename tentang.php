...
<!-- Pendeta Section -->
<section class="section bg-subtle" id="pendeta">
    <div class="container">
...
<!-- Divisi Section -->
<section class="section bg-subtle" id="divisi">
    <div class="container">
        <div class="text-center">
...
<section class="section" id="visi-misi">
    <div class="container">
        ...
        <div style="max-width: 800px; margin: 0 auto; display: flex; flex-direction: column; gap: 30px;">
            <div style="background: white; padding: 35px; border-radius: var(--radius-md); border: 1px solid var(--border-color); box-shadow: var(--shadow-sm); transition: transform 0.3s; cursor: default;">
                <h3 style="color: var(--primary); margin-bottom: 15px; font-size: 1.4rem; border-bottom: 2px solid var(--border-color); padding-bottom: 8px; display: flex; align-items: center; gap: 10px;"><i class="fa-solid fa-eye"></i> Visi</h3>
                <p style="font-size: 1.1rem; color: var(--text-main); line-height: 1.8;"><?= nl2br(htmlspecialchars($visi_text)) ?></p>
            </div>
            <div style="background: white; padding: 35px; border-radius: var(--radius-md); border: 1px solid var(--border-color); box-shadow: var(--shadow-sm); transition: transform 0.3s; cursor: default;">
                <h3 style="color: var(--primary); margin-bottom: 15px; font-size: 1.4rem; border-bottom: 2px solid var(--border-color); padding-bottom: 8px; display: flex; align-items: center; gap: 10px;"><i class="fa-solid fa-bullseye"></i> Misi</h3>
                <ul style="list-style: none; padding: 0;">
                    ...
                    <li style="margin-bottom: 15px; display: flex; gap: 12px; align-items: flex-start;">
                        ...
                        <span style="font-size: 1.05rem; color: var(--text-main); line-height: 1.6;"><?= htmlspecialchars(trim($point)) ?></span>
                    </li>
                    <?php endforeach; ?>
                </ul>
            </div>
