    ...
    <div class="container">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div style="background: white; padding: 25px; border-radius: var(--radius-md); box-shadow: var(--shadow-sm); border-left: 4px solid <?= $border_color ?>;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
                    ...
                    <?php if ($row_warta['butuh_pendaftaran']): ?>
                        <div style="font-size: 0.85rem; color: var(--text-muted); font-weight: 500;">
                            <i class="fa-solid fa-users" style="color: <?= $border_color ?>; margin-right: 4px;"></i> <?= $row_warta['total_pendaftar'] ?> Peserta Terdaftar
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <p style="color: var(--text-muted); line-height: 1.6; <?= $row_warta['butuh_pendaftaran'] ? 'margin-bottom: 20px;' : '' ?>"><?= nl2br(htmlspecialchars($row_warta['isi_pengumuman'])) ?></p>
